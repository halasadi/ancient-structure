...
loglik_squarem <- function(param_vec_in, geno_data, f_obs, n_obs, nsamp, K_unknown, K_known, nSNPs)
{
...
update_squarem <- function(param_vec_in, geno_data, f_obs, n_obs, nsamp, K_unknown, K_known, nSNPs)
{
