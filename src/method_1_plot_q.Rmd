---
title: 'Haak Human Origins analysis: Model 1'
...
Q_data <- as.matrix(read.table("../internal_data/q_known_3_unknown_0.txt"));
...
Q_data <- as.matrix(read.table("../internal_data/q_known_3_unknown_1.txt"));
#Q_data <- as.matrix(read.table("../exploratory/Admixture/haak_fig3_set.5.Q"))
