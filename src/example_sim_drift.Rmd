...
out <- ancient_structure(geno_data = data, f_known = t(freq_mat), K_unknown = K_unknown, max_iter = 50)
...
## Now, we highlight the problems that arise from drift

### (f) without drift K_known = 2, K_uknown = 1
t1 = 1, t2 =1 , alpha = 0.5
